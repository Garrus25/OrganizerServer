...
public class SQLQuery {
    ...
    public static final String GET_GROUPS_USER = "SELECT GROUPS.ID_GROUP,GROUPS.NAME,GROUPS.GROUP_CODE FROM GROUPS JOIN GROUPS_USERS ON GROUPS.ID_GROUP = GROUPS_USERS.ID_GROUP WHERE GROUPS_USERS.ID_USER = ?";
