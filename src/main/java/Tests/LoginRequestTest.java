...
public class LoginRequestTest {
    ...
    void isLoginAvailable_No() throws JsonProcessingException {
        ...
        Request request=new Request(RequestType.REQUEST_IF_USER_LOGIN_AVAILABLE.getNameRequest(), SaveDataAsJson.saveDataAsJson(loginData));
    ...
    public void getIdUserFromLogin() throws JsonProcessingException {
        ...
        Request request=new Request(RequestType.REQUEST_GET_USER_ID_FROM_LOGIN.getNameRequest(), SaveDataAsJson.saveDataAsJson(userLogin));
        Optional<Response> response= Requests.make2(request);
    ...
    public void add_isUserLoginDataValid_GoodData() throws JsonProcessingException {
        ...
        Request request=new Request(RequestType.REQUEST_USER_LOGIN_DATA_VALID.getNameRequest(), SaveDataAsJson.saveDataAsJson(loginAndPassword));
        Optional<Response> response= Requests.make2(request);
